                            ...
                            child: Column(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    String s =
                                        "Hey Checkout this app, ETO Ride \nUser - https://play.google.com/store/apps/details?id=com.mozilitdemo.user\nProvider - https://play.google.com/store/apps/details?id=com.mozilitdemo.provider.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
                                    FlutterShare.share(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                print("smdh");
                                String s =
                                    "Hey Checkout this app, ETO Ride User - https://play.google.com/store/apps/details?id=com.mozilitdemo.user Provider - https://play.google.com/store/apps/details?id=com.mozilitdemo.provider.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
